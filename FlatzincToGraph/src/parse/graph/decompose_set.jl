...
function decompose_array_set_element(args::Vector{Union{Vector{Node},Node}}, graph::Graph)::Graph
    ...
    add_edge(graph, b.id, index_node.id, Edge("0"))
...
function decompose_set_card(args::Vector{Union{Vector{Node},Node}}, graph::Graph)::Graph
    ...
    add_edge(graph, s.id, card_node.id, Edge("0"))
    add_edge(graph, card_node.id, equality_node.id, Edge("0"))
    add_edge(graph, x.id, equality_node.id, Edge("0"))
...
function decompose_set_diff(args::Vector{Union{Vector{Node},Node}}, graph::Graph)::Graph
    ...
    add_edge(graph, x.id, diff_node.id, Edge("0"))
    add_edge(graph, y.id, diff_node.id, Edge("1"))
    add_edge(graph, diff_node.id, equality_node.id, Edge("0"))
    add_edge(graph, r.id, equality_node.id, Edge("0"))
...
function decompose_set_eq(args::Vector{Union{Vector{Node},Node}}, graph::Graph)::Graph
    ...
    add_edge(graph, x.id, equality_node.id, Edge("0"))
    add_edge(graph, y.id, equality_node.id, Edge("0"))
...
function decompose_set_in_reif(args::Vector{Union{Vector{Node},Node}}, graph::Graph)::Graph
    ...
    add_edge(graph, x.id, in_node.id, Edge("0"))
    add_edge(graph, s.id, in_node.id, Edge("1"))
    add_edge(graph, r.id, iff_node.id, Edge("0"))
...
function decompose_set_intersect(args::Vector{Union{Vector{Node},Node}}, graph::Graph)::Graph
    ...
    add_edge(graph, x.id, intersect_node.id, Edge("0"))
    add_edge(graph, y.id, intersect_node.id, Edge("1"))
...
function decompose_set_le(args::Vector{Union{Vector{Node},Node}}, graph::Graph)::Graph
    ...
    add_edge(graph, x.id, leq_node.id, Edge("0"))
    add_edge(graph, y.id, leq_node.id, Edge("1"))
...
function decompose_set_lt(args::Vector{Union{Vector{Node},Node}}, graph::Graph)::Graph
    ...
    add_edge(graph, x.id, le_node.id, Edge("0"))
    add_edge(graph, y.id, le_node.id, Edge("1"))
...
function decompose_set_ne(args::Vector{Union{Vector{Node},Node}}, graph::Graph)::Graph
    ...
    add_edge(graph, x.id, inequality_node.id, Edge("0"))
    add_edge(graph, y.id, inequality_node.id, Edge("0"))
...
function decompose_set_subset(args::Vector{Union{Vector{Node},Node}}, graph::Graph)::Graph
    ...
    add_edge(graph, x.id, subset_node.id, Edge("0"))
    add_edge(graph, y.id, subset_node.id, Edge("0"))
...
function decompose_set_subset_reif(args::Vector{Union{Vector{Node},Node}}, graph::Graph)::Graph
    ...
    add_edge(graph, x.id, subset_node.id, Edge("0"))
    add_edge(graph, y.id, subset_node.id, Edge("1"))
    add_edge(graph, r.id, iff_node.id, Edge("0"))
...
function decompose_set_symdiff(args::Vector{Union{Vector{Node},Node}}, graph::Graph)::Graph
    ...
    add_edge(graph, x.id, symdiff_node.id, Edge("0"))
    add_edge(graph, y.id, symdiff_node.id, Edge("1"))
...
function decompose_set_union(args::Vector{Union{Vector{Node},Node}}, graph::Graph)::Graph
    ...
    add_edge(graph, x.id, union_node.id, Edge("0"))
    add_edge(graph, y.id, union_node.id, Edge("0"))
