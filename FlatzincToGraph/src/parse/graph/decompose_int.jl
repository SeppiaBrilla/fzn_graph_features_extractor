...
function decompose_int_lin_le(args::Vector{Union{Vector{Node},Node}}, graph::Graph)::Graph
    ...
    add_node(graph, leq)
    add_edge(graph, c.id, leq.id, Edge("1"))
...
function decompose_int_abs(args::Vector{Union{Vector{Node},Node}}, graph::Graph)::Graph
    ...
    add_edge(graph, a.id, abs_node.id, Edge("0"))
...
function decompose_int_div(args::Vector{Union{Vector{Node},Node}}, graph::Graph)::Graph
    ...
    add_edge(graph, a.id, division_node.id, Edge("0"))
    add_edge(graph, b.id, division_node.id, Edge("1"))
...
function decompose_int_eq_reif(args::Vector{Union{Vector{Node},Node}}, graph::Graph)::Graph
    ...
    add_edge(graph, a.id, equality_node.id, Edge("0"))
    add_edge(graph, b.id, equality_node.id, Edge("0"))
    add_edge(graph, r.id, iif_node.id, Edge("0"))
...
function decompose_int_lin_ne(args::Vector{Union{Vector{Node},Node}}, graph::Graph)::Graph
    ...
    add_node(graph, neq)
    add_edge(graph, c.id, neq.id, Edge("0"))
...
function decompose_int_max(args::Vector{Union{Vector{Node},Node}}, graph::Graph)::Graph
    ...
    add_edge(graph, a.id, max_node.id, Edge("0"))
    add_edge(graph, b.id, max_node.id, Edge("0"))
    add_edge(graph, max_node.id, eq_node.id, Edge("0"))
    add_edge(graph, c.id, eq_node.id, Edge("0"))
...
function decompose_int_min(args::Vector{Union{Vector{Node},Node}}, graph::Graph)::Graph
    ...
    add_edge(graph, a.id, min_node.id, Edge("0"))
    add_edge(graph, b.id, min_node.id, Edge("0"))
...
function decompose_int_mod(args::Vector{Union{Vector{Node},Node}}, graph::Graph)::Graph
    ...
    add_edge(graph, a.id, mod_node.id, Edge("0"))
    add_edge(graph, b.id, mod_node.id, Edge("0"))
...
function decompose_int_ne(args::Vector{Union{Vector{Node},Node}}, graph::Graph)::Graph
    ...
    add_edge(graph, a.id, neq_node.id, Edge("0"))
    add_edge(graph, b.id, neq_node.id, Edge("0"))
...
function decompose_int_plus(args::Vector{Union{Vector{Node},Node}}, graph::Graph)::Graph
    ...
    add_edge(graph, a.id, sum_node.id, Edge("0"))
    add_edge(graph, b.id, sum_node.id, Edge("0"))
...
function decompose_int_pow(args::Vector{Union{Vector{Node},Node}}, graph::Graph)::Graph
    ...
    add_edge(graph, x.id, pow_node.id, Edge("0"))
    add_edge(graph, y.id, pow_node.id, Edge("1"))
    add_edge(graph, pow_node.id, eq_node.id, Edge("0"))
    add_edge(graph, z.id, eq_node.id, Edge("0"))
